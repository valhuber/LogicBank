...
if  __name__ == '__main__':
    ...
    sys.argv = [sys.argv[0]]
    unittest.main(module="examples.nw.tests.test_upd_order_reuse")
    exit(0)
else:
...
class Test(unittest.TestCase):
    ...
    def test_run(self):
        ...
        """
        This test uncovered a dragon - a serious and subtle bug (now fixed).
            Other resources: see....
        ...
        Failed run:
            @test_upd_order_reuse.py#<module>(): Reparenting *altered* order - new CustomerId: ANATR
            ...
            *** ERROR***
            ...
            Traceback (most recent call last):
              ...
              File "/Users/val/python/pycharm/logic-bank/nw/tests/test_upd_order_reuse.py", line 136, in <module>
                assert False
            AssertionError
