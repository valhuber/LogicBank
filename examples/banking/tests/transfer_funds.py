...
from examples.banking.tests import setup_db  # careful - this must follow fix-path, above
setup_db()

# pyc guess:  from examples import banking as models (also wrong on logic.session)
from examples.banking.db import models
from logic_bank.exec_row_logic.logic_row import LogicRow
from examples.banking.logic import session  # opens db, activates logic listener <--
